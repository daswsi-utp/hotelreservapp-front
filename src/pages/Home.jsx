    ...
    <div>
      ...
      <section className="py-16 bg-primary text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <button onClick={() => navigate('src/pages/Reservation.jsx')} className="bg-secondary hover:bg-yellow-600 text-white font-bold py-3 px-8 rounded-full text-lg transition-colors">
          Book now
          </button>
        </div>
      </section>
