...
import { messages } from '../../data/roomsData';
        ...
        <div style={messagesStyles.filtersContainer}>
          <button 
            style={{
              ...
              ...(filter === 'all' ? messagesStyles.activeFilterButton : {})
            }}
          ...
          <button 
            style={{
              ...messagesStyles.filterButton,
              ...(filter === 'unread' ? messagesStyles.activeFilterButton : {})
            }}
          ...
          <button 
            style={{
              ...messagesStyles.filterButton,
              ...(filter === 'read' ? messagesStyles.activeFilterButton : {})
            }}
      ...
      <div style={{
        ...
        >
          {filteredMessages.length > 0 ? (
            ...
            <div style={messagesStyles.noResults}>
          ...
          {selectedMessage ? (
            <>
              <div style={messagesStyles.messageDetailHeader}>
                <h2 style={messagesStyles.messageDetailSubject}>
                ...
                <div style={messagesStyles.messageDetailSender}>
                  ...
                  <span style={messagesStyles.messageDetailDate}>
                    {format(selectedMessage.date, 'MMMM dd, yyyy')}
                  </span>
                </div>
              </div>
